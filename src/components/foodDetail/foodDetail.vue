  ...
  <transition name="move">
    <div class="detailWrapper" ref="detailWrapper" v-show="showDetail">
      <div class="foodDetail">
        ...
        <img :src="food.icon" height="425" width="100%">
        <div class="info">
          <div class="title">{{food.dishesName}}</div>
          <div class="price">
            <span class="unit">￥</span>{{food.dishesPriceNow}}
        ...
        <div class="desc">
          ...
          <div class="content">{{food.dishesDescription}}</div>
        </div>
        <div class="divider"></div>
      </div>
    </div>
